...
sys.path.append('./pyMDNet/modules')
sys.path.append('./pyMDNet/tracking')
# pymdnet
...
sys.path.append('SiamMask/experiments/siammask')
...
class Dimp_LTMU_Tracker(object):
    def __init__(self, image, region, p=None, groundtruth=None, tracker_name='dimp', tracker_params='dimp50'):
        ...
        local_state1, self.score_map, update, self.score_max, dis, flag, update_score = self.local_track(image)
    ...
    def siammask_init(self, im, init_gt):
        ...
        parser.add_argument('--resume', default='SiamMask/experiments/siammask/SiamMask_VOT_LD.pth',
                            type=str,
