...
parser.add_argument('tracker_params', type=str, default='dimp50_depth',
                    help='ltr.parameter.trackerName.trackerParams, e.g. dimp50, dimp50_depth, dimp50_colormap')
parser.add_argument('--dataset_name', type=str, default='votlt19',
...
eval_tracking(args.dataset_name, p=p, tracker_name=args.tracker_name, tracker_params=args.tracker_params)
